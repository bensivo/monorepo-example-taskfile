...
// @generated from file proto/greetings/v1/greetings.proto (package greetings.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message greetings.v1.GreetRequest
 */
export class GreetRequest extends Message<GreetRequest> {
  ...
  static readonly typeName = "greetings.v1.GreetRequest";
...
/**
 * @generated from message greetings.v1.GreetResponse
 */
export class GreetResponse extends Message<GreetResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "greetings.v1.GreetResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
